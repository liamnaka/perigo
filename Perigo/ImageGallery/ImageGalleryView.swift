 ...
 */
  ...
  func updateFrames() {
    ...
    collectionView.frame = CGRect(x: 0, y: 2, width: totalWidth, height: collectionFrame-4)
 ...
 */
   ...
   /* manager.requestImage(for: asset, targetSize: CGSize(width:598,height:598), contentMode: .aspectFill, options: nil, resultHandler: {
        (result, info)->Void in
